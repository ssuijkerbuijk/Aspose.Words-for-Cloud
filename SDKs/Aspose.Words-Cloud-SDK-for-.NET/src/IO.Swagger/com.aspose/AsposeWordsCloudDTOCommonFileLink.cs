...
namespace IO.Swagger.com.aspose
{
    ...
    /// </summary>
    [DataContract]
    public partial class AsposeWordsCloudDTOCommonFileLink :  IEquatable<AsposeWordsCloudDTOCommonFileLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AsposeWordsCloudDTOCommonFileLink" /> class.
        /// </summary>
        ...
        public AsposeWordsCloudDTOCommonFileLink(string Href = default(string), string Rel = default(string), string Type = default(string), string Title = default(string))
        {
            this.Href = Href;
            this.Rel = Rel;
            this.Type = Type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AsposeWordsCloudDTOCommonFileLink {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AsposeWordsCloudDTOCommonFileLink);
        }

        /// <summary>
        /// Returns true if AsposeWordsCloudDTOCommonFileLink instances are equal
        /// </summary>
        /// <param name="other">Instance of AsposeWordsCloudDTOCommonFileLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsposeWordsCloudDTOCommonFileLink other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
