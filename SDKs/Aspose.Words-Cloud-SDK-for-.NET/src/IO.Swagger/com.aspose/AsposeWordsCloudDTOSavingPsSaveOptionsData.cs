...
namespace IO.Swagger.com.aspose
{
    ...
    /// </summary>
    [DataContract]
    public partial class AsposeWordsCloudDTOSavingPsSaveOptionsData :  IEquatable<AsposeWordsCloudDTOSavingPsSaveOptionsData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AsposeWordsCloudDTOSavingPsSaveOptionsData" /> class.
        /// </summary>
        ...
        public AsposeWordsCloudDTOSavingPsSaveOptionsData(bool? UseBookFoldPrintingSettings = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AsposeWordsCloudDTOSavingPsSaveOptionsData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AsposeWordsCloudDTOSavingPsSaveOptionsData);
        }

        /// <summary>
        /// Returns true if AsposeWordsCloudDTOSavingPsSaveOptionsData instances are equal
        /// </summary>
        /// <param name="other">Instance of AsposeWordsCloudDTOSavingPsSaveOptionsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsposeWordsCloudDTOSavingPsSaveOptionsData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
