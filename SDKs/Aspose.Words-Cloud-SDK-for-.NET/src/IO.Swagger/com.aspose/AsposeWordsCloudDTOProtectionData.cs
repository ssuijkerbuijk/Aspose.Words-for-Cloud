...
namespace IO.Swagger.com.aspose
{
    ...
    /// </summary>
    [DataContract]
    public partial class AsposeWordsCloudDTOProtectionData :  IEquatable<AsposeWordsCloudDTOProtectionData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AsposeWordsCloudDTOProtectionData" /> class.
        /// </summary>
        /// <param name="ProtectionType">Type of the protection.</param>
        public AsposeWordsCloudDTOProtectionData(string ProtectionType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AsposeWordsCloudDTOProtectionData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AsposeWordsCloudDTOProtectionData);
        }

        /// <summary>
        /// Returns true if AsposeWordsCloudDTOProtectionData instances are equal
        /// </summary>
        /// <param name="other">Instance of AsposeWordsCloudDTOProtectionData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsposeWordsCloudDTOProtectionData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
