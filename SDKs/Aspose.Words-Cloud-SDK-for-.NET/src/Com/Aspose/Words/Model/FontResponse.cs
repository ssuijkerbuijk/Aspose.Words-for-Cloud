...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="FontResponse" /> class.
        /// </summary>
        /// <param name="Font">Font.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public FontResponse(Font Font = default(Font), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
                        this.Font = Font;
                        this.Code = Code;
                        this.Status = Status;
