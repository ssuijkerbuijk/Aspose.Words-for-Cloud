...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="BorderResponse" /> class.
        /// </summary>
        /// <param name="Border">Border.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public BorderResponse(Border Border = default(Border), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
                        this.Border = Border;
                        this.Code = Code;
                        this.Status = Status;
