...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="FootnotesResponse" /> class.
        /// </summary>
        /// <param name="Footnotes">Footnotes.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public FootnotesResponse(FootnoteCollectionDto Footnotes = default(FootnoteCollectionDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
