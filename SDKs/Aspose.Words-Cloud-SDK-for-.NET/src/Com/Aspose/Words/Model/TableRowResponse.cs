...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="TableRowResponse" /> class.
        /// </summary>
        /// <param name="Row">Row.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public TableRowResponse(TableRowDto Row = default(TableRowDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
                        this.Row = Row;
                        this.Code = Code;
                        this.Status = Status;
