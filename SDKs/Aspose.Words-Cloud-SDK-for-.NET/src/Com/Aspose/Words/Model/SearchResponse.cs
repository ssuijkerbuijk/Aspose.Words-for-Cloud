...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        ...
        /// </summary>
        /// <param name="SearchingPattern">SearchingPattern.</param>
        /// <param name="SearchResults">SearchResults.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public SearchResponse(string SearchingPattern = default(string), SearchResultsCollection SearchResults = default(SearchResultsCollection), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
