...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="FormFieldResponse" /> class.
        /// </summary>
        /// <param name="FormField">FormField.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public FormFieldResponse(FormField FormField = default(FormField), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
