...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="RevisionsModificationResponse" /> class.
        /// </summary>
        /// <param name="Result">Result.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public RevisionsModificationResponse(ModificationOperationResult Result = default(ModificationOperationResult), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
                        this.Result = Result;
                        this.Code = Code;
                        this.Status = Status;
