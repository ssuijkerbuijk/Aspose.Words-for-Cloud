...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="TablePropertiesResponse" /> class.
        /// </summary>
        /// <param name="Properties">Properties.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public TablePropertiesResponse(TablePropertiesDto Properties = default(TablePropertiesDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
