...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        ...
        /// </summary>
        /// <param name="AllCaps">AllCaps.</param>
        /// <param name="Bidi">Bidi.</param>
        /// <param name="Bold">Bold.</param>
        /// <param name="BoldBi">BoldBi.</param>
        /// <param name="Border">Border.</param>
        /// <param name="Color">Color.</param>
        /// <param name="ComplexScript">ComplexScript.</param>
        /// <param name="DoubleStrikeThrough">DoubleStrikeThrough.</param>
        /// <param name="Emboss">Emboss.</param>
        /// <param name="Engrave">Engrave.</param>
        /// <param name="Hidden">Hidden.</param>
        /// <param name="HighlightColor">HighlightColor.</param>
        /// <param name="Italic">Italic.</param>
        /// <param name="ItalicBi">ItalicBi.</param>
        /// <param name="Kerning">Kerning.</param>
        /// <param name="LocaleId">LocaleId.</param>
        /// <param name="LocaleIdBi">LocaleIdBi.</param>
        /// <param name="LocaleIdFarEast">LocaleIdFarEast.</param>
        /// <param name="Name">Name.</param>
        /// <param name="NameAscii">NameAscii.</param>
        /// <param name="NameBi">NameBi.</param>
        /// <param name="NameFarEast">NameFarEast.</param>
        /// <param name="NameOther">NameOther.</param>
        /// <param name="NoProofing">NoProofing.</param>
        /// <param name="Outline">Outline.</param>
        /// <param name="Position">Position.</param>
        /// <param name="Scaling">Scaling.</param>
        /// <param name="Shadow">Shadow.</param>
        /// <param name="Size">Size.</param>
        /// <param name="SizeBi">SizeBi.</param>
        /// <param name="SmallCaps">SmallCaps.</param>
        ...
        /// <param name="Superscript">Superscript.</param>
        /// <param name="TextEffect">TextEffect.</param>
        /// <param name="Underline">Underline.</param>
        /// <param name="UnderlineColor">UnderlineColor.</param>
        /// <param name="Link">Link.</param>
        public Font(bool? AllCaps = default(bool?), bool? Bidi = default(bool?), bool? Bold = default(bool?), bool? BoldBi = default(bool?), Border Border = default(Border), XmlColor Color = default(XmlColor), bool? ComplexScript = default(bool?), bool? DoubleStrikeThrough = default(bool?), bool? Emboss = default(bool?), bool? Engrave = default(bool?), bool? Hidden = default(bool?), XmlColor HighlightColor = default(XmlColor), bool? Italic = default(bool?), bool? ItalicBi = default(bool?), double? Kerning = default(double?), int? LocaleId = default(int?), int? LocaleIdBi = default(int?), int? LocaleIdFarEast = default(int?), string Name = default(string), string NameAscii = default(string), string NameBi = default(string), string NameFarEast = default(string), string NameOther = default(string), bool? NoProofing = default(bool?), bool? Outline = default(bool?), double? Position = default(double?), int? Scaling = default(int?), bool? Shadow = default(bool?), double? Size = default(double?), double? SizeBi = default(double?), bool? SmallCaps = default(bool?), double? Spacing = default(double?), bool? StrikeThrough = default(bool?), StyleIdentifierEnum? StyleIdentifier = default(StyleIdentifierEnum?), string StyleName = default(string), bool? Subscript = default(bool?), bool? Superscript = default(bool?), TextEffectEnum? TextEffect = default(TextEffectEnum?), UnderlineEnum? Underline = default(UnderlineEnum?), XmlColor UnderlineColor = default(XmlColor), WordsApiLink Link = default(WordsApiLink))
        {
