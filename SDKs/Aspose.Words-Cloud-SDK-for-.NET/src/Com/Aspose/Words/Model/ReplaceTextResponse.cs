...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceTextResponse" /> class.
        /// </summary>
        /// <param name="Matches">Matches.</param>
        /// <param name="DocumentLink">DocumentLink.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public ReplaceTextResponse(int? Matches = default(int?), FileLink DocumentLink = default(FileLink), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
