...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionLinkCollectionResponse" /> class.
        /// </summary>
        /// <param name="Sections">Sections.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public SectionLinkCollectionResponse(SectionLinkCollection Sections = default(SectionLinkCollection), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
