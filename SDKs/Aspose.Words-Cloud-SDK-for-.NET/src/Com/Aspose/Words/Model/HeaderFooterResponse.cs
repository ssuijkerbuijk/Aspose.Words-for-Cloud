...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="HeaderFooterResponse" /> class.
        /// </summary>
        /// <param name="HeaderFooter">HeaderFooter.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public HeaderFooterResponse(HeaderFooterDto HeaderFooter = default(HeaderFooterDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
