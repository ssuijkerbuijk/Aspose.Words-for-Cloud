...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="StatDataResponse" /> class.
        /// </summary>
        /// <param name="StatData">StatData.</param>
        /// <param name="DocumentLink">DocumentLink.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public StatDataResponse(DocumentStatData StatData = default(DocumentStatData), FileLink DocumentLink = default(FileLink), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
