...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="TableCellFormatResponse" /> class.
        /// </summary>
        /// <param name="CellFormat">CellFormat.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public TableCellFormatResponse(TableCellFormatDto CellFormat = default(TableCellFormatDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
