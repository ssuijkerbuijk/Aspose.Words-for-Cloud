...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="OfficeMathObjectResponse" /> class.
        /// </summary>
        /// <param name="OfficeMathObject">OfficeMathObject.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public OfficeMathObjectResponse(OfficeMathObjectDto OfficeMathObject = default(OfficeMathObjectDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
