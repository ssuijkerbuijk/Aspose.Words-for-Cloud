...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="DrawingObjectResponse" /> class.
        /// </summary>
        /// <param name="DrawingObject">DrawingObject.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public DrawingObjectResponse(DrawingObjectDto DrawingObject = default(DrawingObjectDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
