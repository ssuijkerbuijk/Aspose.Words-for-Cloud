...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="HyperlinkResponse" /> class.
        /// </summary>
        /// <param name="Hyperlink">Hyperlink.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public HyperlinkResponse(Hyperlink Hyperlink = default(Hyperlink), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
