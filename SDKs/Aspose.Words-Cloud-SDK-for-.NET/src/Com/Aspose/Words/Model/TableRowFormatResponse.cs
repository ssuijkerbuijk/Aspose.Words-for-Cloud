...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="TableRowFormatResponse" /> class.
        /// </summary>
        /// <param name="RowFormat">RowFormat.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public TableRowFormatResponse(TableRowFormatDto RowFormat = default(TableRowFormatDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
