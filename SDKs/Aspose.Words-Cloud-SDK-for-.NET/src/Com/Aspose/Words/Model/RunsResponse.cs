...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="RunsResponse" /> class.
        /// </summary>
        /// <param name="Runs">Runs.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public RunsResponse(RunsDto Runs = default(RunsDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
                        this.Runs = Runs;
                        this.Code = Code;
                        this.Status = Status;
