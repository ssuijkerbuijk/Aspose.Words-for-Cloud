...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="HyperlinksResponse" /> class.
        /// </summary>
        /// <param name="Hyperlinks">Hyperlinks.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public HyperlinksResponse(Hyperlinks Hyperlinks = default(Hyperlinks), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
