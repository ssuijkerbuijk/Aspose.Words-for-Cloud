...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="BordersResponse" /> class.
        /// </summary>
        /// <param name="Borders">Borders.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public BordersResponse(BordersCollection Borders = default(BordersCollection), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
