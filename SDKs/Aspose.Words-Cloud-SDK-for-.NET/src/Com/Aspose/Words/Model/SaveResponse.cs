...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        ...
        /// </summary>
        /// <param name="SaveResult">SaveResult.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public SaveResponse(SaveResult SaveResult = default(SaveResult), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
