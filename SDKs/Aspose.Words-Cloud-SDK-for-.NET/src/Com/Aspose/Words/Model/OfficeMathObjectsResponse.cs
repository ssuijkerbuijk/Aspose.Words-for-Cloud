...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="OfficeMathObjectsResponse" /> class.
        /// </summary>
        /// <param name="OfficeMathObjects">OfficeMathObjects.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public OfficeMathObjectsResponse(OfficeMathObjectsCollectionDto OfficeMathObjects = default(OfficeMathObjectsCollectionDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
        ...
        /// </summary>    
        public OfficeMathObjectsCollectionDto OfficeMathObjects { get; set; }
