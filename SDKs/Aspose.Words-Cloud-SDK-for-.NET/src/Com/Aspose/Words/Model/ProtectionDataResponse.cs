...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtectionDataResponse" /> class.
        /// </summary>
        /// <param name="ProtectionData">ProtectionData.</param>
        /// <param name="DocumentLink">DocumentLink.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public ProtectionDataResponse(ProtectionData ProtectionData = default(ProtectionData), FileLink DocumentLink = default(FileLink), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
