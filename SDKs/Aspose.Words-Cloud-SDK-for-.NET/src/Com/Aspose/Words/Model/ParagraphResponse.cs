...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="ParagraphResponse" /> class.
        /// </summary>
        /// <param name="Paragraph">Paragraph.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public ParagraphResponse(ParagraphDto Paragraph = default(ParagraphDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
