...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        ...
        public DocumentPropertyResponse(DocumentProperty DocumentProperty = default(DocumentProperty), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
