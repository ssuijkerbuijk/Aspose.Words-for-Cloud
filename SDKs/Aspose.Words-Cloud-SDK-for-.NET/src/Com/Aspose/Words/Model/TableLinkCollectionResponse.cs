...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="TableLinkCollectionResponse" /> class.
        /// </summary>
        /// <param name="Tables">Tables.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public TableLinkCollectionResponse(TableLinkCollection Tables = default(TableLinkCollection), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
                        this.Tables = Tables;
                        this.Code = Code;
                        this.Status = Status;
