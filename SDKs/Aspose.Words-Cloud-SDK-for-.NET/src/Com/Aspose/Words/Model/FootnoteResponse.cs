...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="FootnoteResponse" /> class.
        /// </summary>
        /// <param name="Footnote">Footnote.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public FootnoteResponse(FootnoteDto Footnote = default(FootnoteDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
