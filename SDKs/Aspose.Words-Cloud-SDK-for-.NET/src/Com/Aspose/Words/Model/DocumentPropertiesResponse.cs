...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        ...
        public DocumentPropertiesResponse(DocumentProperties DocumentProperties = default(DocumentProperties), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
