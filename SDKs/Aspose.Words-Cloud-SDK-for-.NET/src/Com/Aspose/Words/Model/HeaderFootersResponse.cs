...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="HeaderFootersResponse" /> class.
        /// </summary>
        /// <param name="HeaderFooters">HeaderFooters.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public HeaderFootersResponse(HeaderFooterLinkCollection HeaderFooters = default(HeaderFooterLinkCollection), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
