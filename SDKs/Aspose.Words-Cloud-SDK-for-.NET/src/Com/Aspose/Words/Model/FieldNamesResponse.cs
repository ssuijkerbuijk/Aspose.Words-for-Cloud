...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldNamesResponse" /> class.
        /// </summary>
        /// <param name="FieldNames">FieldNames.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public FieldNamesResponse(FieldNames FieldNames = default(FieldNames), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
