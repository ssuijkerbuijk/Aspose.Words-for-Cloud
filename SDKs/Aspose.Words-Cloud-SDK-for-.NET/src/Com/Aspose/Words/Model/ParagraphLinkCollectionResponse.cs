...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="ParagraphLinkCollectionResponse" /> class.
        /// </summary>
        /// <param name="Paragraphs">Paragraphs.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public ParagraphLinkCollectionResponse(ParagraphLinkCollection Paragraphs = default(ParagraphLinkCollection), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
