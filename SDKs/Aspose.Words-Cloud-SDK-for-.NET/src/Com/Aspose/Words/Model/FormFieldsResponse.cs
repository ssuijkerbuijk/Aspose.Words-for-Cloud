...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="FormFieldsResponse" /> class.
        /// </summary>
        /// <param name="FormFields">FormFields.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public FormFieldsResponse(FormFieldCollectionDto FormFields = default(FormFieldCollectionDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
