...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        ...
        public FieldsResponse(FieldCollectionDto Fields = default(FieldCollectionDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
                        this.Fields = Fields;
                        this.Code = Code;
                        this.Status = Status;
        ...
        /// Gets or sets Fields
        /// </summary>    
        public FieldCollectionDto Fields { get; set; }
