...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="CommentsResponse" /> class.
        /// </summary>
        /// <param name="Comments">Comments.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public CommentsResponse(CommentsCollection Comments = default(CommentsCollection), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
