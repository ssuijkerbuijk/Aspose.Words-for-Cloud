...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="TableCellResponse" /> class.
        /// </summary>
        /// <param name="Cell">Cell.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public TableCellResponse(TableCellDto Cell = default(TableCellDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
                        this.Cell = Cell;
                        this.Code = Code;
                        this.Status = Status;
