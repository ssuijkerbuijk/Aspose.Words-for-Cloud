...
namespace Com.Aspose.Words.Model 
{
  ...
  {           
        /// <summary>
        /// Initializes a new instance of the <see cref="DrawingObjectsResponse" /> class.
        /// </summary>
        /// <param name="DrawingObjects">DrawingObjects.</param>
        /// <param name="Code">Code.</param>
        /// <param name="Status">Status.</param>
        public DrawingObjectsResponse(DrawingObjectCollectionDto DrawingObjects = default(DrawingObjectCollectionDto), CodeEnum? Code = default(CodeEnum?), string Status = default(string))
        {
