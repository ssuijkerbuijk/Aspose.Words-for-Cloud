...
use \ArrayAccess;
/**
 * OfficeMathObjectResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OfficeMathObjectResponse implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        'office_math_object' => '\Swagger\Client\Model\OfficeMathObject',
        'code' => 'string',
        'status' => 'string'
    );
    ...
    {
        if ($data != null) {
            $this->office_math_object = $data["office_math_object"];
            $this->code = $data["code"];
    ...
    {
        return $this->office_math_object;
    }
  
    /**
     * Sets office_math_object
     * @param \Swagger\Client\Model\OfficeMathObject $office_math_object 
     * @return $this
     */
    public function setOfficeMathObject($office_math_object)
    {
        
        $this->office_math_object = $office_math_object;
        return $this;
    }
