...
class GetDocumentDrawingObjectImageDataExample
{
    function main(){
        ...
        $request = new GetDocumentDrawingObjectImageDataRequest($remoteName, $index, $folder=null,
...
$drawing = new GetDocumentDrawingObjectImageDataExample();
$drawing->main();
