...
class DeleteDrawingObjectExample
{
    function main(){
        ...
        $request = newDeleteDrawingObjectRequest($remoteName,
            $objectIndex, $folder=null,
            null, null, null, null,
            null, null, "");
        $result = $wordsAPI->deleteDrawingObject($request);
        echo $result;
    }
}

$drawing = new DeleteDrawingObjectExample();
$drawing->main();
