...
#set input file name
filename = "SampleHeaderFooterWordDocument.docx"
...
try:
    ...
    response = wordsApi.DeleteHeadersFooters(name=filename, filename=destfilename)

    if response.Status == "OK":
        print "All headers and footers have been deleted successfully"
