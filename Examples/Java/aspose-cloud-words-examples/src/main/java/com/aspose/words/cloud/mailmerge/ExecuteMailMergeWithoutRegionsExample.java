...
public class ExecuteMailMergeWithoutRegionsExample {

	public static void main(String[] args) {
		// ExStart: ExecuteMailMergeWithoutRegionsExample
		...
		try {
			...
			storageApi.PutCreate(fileName, "", "",
					new File(ExecuteMailMergeWithoutRegionsExample.class.getResource("/" + fileName).toURI()));
		...
		// ExEnd: ExecuteMailMergeWithoutRegionsExample
